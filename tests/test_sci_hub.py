...
class TestSciHubFetcher(unittest.TestCase):
    ...
    def test_init_custom_url(self):
        ...
        custom_fetcher = SciHubFetcher(
            base_url="https://sci-hub.ru/", output_dir=self.test_dir
        )
    ...
    def test_download_pdf_known_doi(self):
        ...
        if success_count == 0:
            ...
            print(
                "All downloads failed - this may be expected due to Sci-Hub blocking or CAPTCHA"
            )
    ...
    def test_error_handling(self):
        ...
        result = self.fetcher.download_pdf(
            "this-is-definitely-not-a-valid-doi-or-identifier-12345"
        )
